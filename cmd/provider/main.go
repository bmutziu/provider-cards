...
import (
	...
	"github.com/bmutziu/provider-cards/internal/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-cards"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-cards",
